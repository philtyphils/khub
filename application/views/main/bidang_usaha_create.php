            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="header" style="background-color: #43425D">
                        <h4 class="title" style="color: #ffff;">Create Bidang Usaha</h4>
                    </div>
                    <div class="card-form">
                        <?php echo $this->session->flashdata('teks'); ?>
                        <form action="<?php echo $baseurl;?>bidang_usaha/submit/create" method="POST">
                            <div class="row">
                                <div class="form-group">
                                    <label for="name">Nama Bidang Usaha</label>
                                    <input type="text" name="nama" id="" class="form-control" required placeholder="Nama Bidang Usaha">
                                </div>
